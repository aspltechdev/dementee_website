...
<section className="dm-career-roles-section">
  ...
  <div className="dm-career-roles-grid">
    ...
    <article className="dm-career-role-card">
      <div className="dm-career-role-icon">🧾</div>
    ...
    <article className="dm-career-role-card">
      <div className="dm-career-role-icon">✉️</div>
...
<section className="dm-final-section">
  ...
  <div className="dm-journey-cta">
    ...
    <a href="#dm-enroll" className="dm-journey-enroll">
      ENROLL NOW
    </a>
  </div>
...
<footer className="dm-footer">
  ...
  />
    ...
    {/* INFORMATION */}
    <div className="dm-footer-column dm-footer-info">
      <a href="#dm-enroll" className="dm-footer-enroll">
        Enroll Today
      </a>
  ...
  <div className="dm-footer-divider"></div>
